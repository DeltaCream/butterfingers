...
async function get_enroll_stages(id, empname) {
    ...
    document.getElementById("proc-num").innerHTML =
        "Please press your right index finger at the fingerprint scanner " +
        stages +
        " times, making sure it blinks each time.";
    ...
    if (result && result.responsecode === "success") {
        ...
        document.getElementById("succ-id").innerHTML =
            "For Employee: " + fempname + " ID: " + id;
    } else {
